...
const JourneyPage: FC = () => {
    return (
        <div className={styles.arrowContainer}>
            <Image src={require('../../../assets/backgroundImage/Journey Arrow.png')} alt='' className={styles.arrow1} />
            <Image src={require('../../../assets/backgroundImage/Journey Arrow.png')} alt='' className={styles.arrow2} />
            <Image src={require('../../../assets/backgroundImage/Journey Arrow.png')} alt='' className={styles.arrow3} />
            <div className={styles.container}>
                ...
                <div className={styles.contentContainer}>
                    <div className={styles.contentItemContainer}>
                        <Image src={require('../../../assets/backgroundImage/Journey 1.png')} alt='journey 1' className={styles.photo}/>
                    ...
                    <div className={styles.contentItemContainer}>
                        ...
                        <Image src={require('../../../assets/backgroundImage/Journey 2.png')} alt='journey 2' className={styles.photo}/>
                    </div>
                    <div className={styles.contentItemContainer}>
                        <Image src={require('../../../assets/backgroundImage/Journey 3.png')} alt='journey 3' className={styles.photo}/>
                    ...
                    <div className={styles.contentItemContainer}>
                        ...
                        <Image src={require('../../../assets/backgroundImage/Journey 4.png')} alt='journey 4' className={styles.photo}/>
                    </div>
                </div>
            </div>
        </div>
